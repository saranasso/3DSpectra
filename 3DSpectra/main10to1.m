...
fileHeaderA=x10zu1A;
fileHeaderA.localFullPath=[dataDir filesep x10zu1A.folderName filesep];
fileHeaderB=x10zu1B;
fileHeaderB.localFullPath=[dataDir filesep x10zu1B.folderName filesep];
fileHeaderC=x10zu1C;
fileHeaderC.localFullPath=[dataDir filesep x10zu1C.folderName filesep];
