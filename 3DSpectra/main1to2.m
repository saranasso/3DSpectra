...
fileHeaderA=x1zu2A;
fileHeaderA.localFullPath=[dataDir filesep x1zu2A.folderName filesep];
fileHeaderB=x1zu2B;
fileHeaderB.localFullPath=[dataDir filesep x1zu2B.folderName filesep];
fileHeaderC=x1zu2C;
fileHeaderC.localFullPath=[dataDir filesep x1zu2C.folderName filesep];

%% initializing variables & parameters
pep_idx=1;
j=1; % USARE LO STESSO CONTATORE
