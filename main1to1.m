...
fileHeaderA=x1zu1A;
fileHeaderA.localFullPath=[dataDir filesep x1zu1A.folderName filesep];
fileHeaderB=x1zu1B;
fileHeaderB.localFullPath=[dataDir filesep x1zu1B.folderName filesep];
fileHeaderC=x1zu1C;
fileHeaderC.localFullPath=[dataDir filesep x1zu1C.folderName filesep];
