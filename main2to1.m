...
fileHeaderA=x2zu1A;
fileHeaderA.localFullPath=[dataDir filesep x2zu1A.folderName filesep];
fileHeaderB=x2zu1B;
fileHeaderB.localFullPath=[dataDir filesep x2zu1B.folderName filesep];
fileHeaderC=x2zu1C;
fileHeaderC.localFullPath=[dataDir filesep x2zu1C.folderName filesep];
