...
fileHeaderA=x5zu1A;
fileHeaderA.localFullPath=[dataDir filesep x5zu1A.folderName filesep];
fileHeaderB=x5zu1B;
fileHeaderB.localFullPath=[dataDir filesep x5zu1B.folderName filesep];
fileHeaderC=x5zu1C;
fileHeaderC.localFullPath=[dataDir filesep x5zu1C.folderName filesep];
